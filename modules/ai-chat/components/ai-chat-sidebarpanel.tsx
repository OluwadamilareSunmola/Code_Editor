                                                ...
                                                <ReactMarkdown
                                                    ...
                                                    components={{
                                                        code: ({ children, className, inline, node, ...props }) => {
                                                            ...
                                                            return (
                                                                <pre className="bg-zinc-800 rounded-lg p-4 my-4 text-sm text-zinc-100 overflow-x-auto">
                                                        ...
                                                        p: ({ children, node, ...props }) => {
                                                            ...
                                                            if (node && node.children && node.children.some((child: any) => child.tagName === 'pre' || child.tagName === 'code')) {
                                                                return <>{children}</>;
                                                            }
